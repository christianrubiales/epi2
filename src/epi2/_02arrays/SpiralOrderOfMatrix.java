...
public class SpiralOrderOfMatrix {
	...
	public static void main(String[] args) {
		...
		System.out.println(spiralOrder(M));// 1, 2, 3, 4, 8, 12, 11, 10, 9, 5, 6, 7
		...
		System.out.println(spiralOrder(M)); // 1, 2, 3, 4, 8, 12, 16, 15, 14, 13, 9, 5, 6, 7, 11, 10
		...
		System.out.println(spiralOrder(M)); // 1, 2, 3, 4, 8, 12, 16, 20, 19, 18, 17, 13, 9, 5, 6, 7, 11, 15, 14, 10
	}
