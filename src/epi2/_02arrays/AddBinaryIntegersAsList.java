...
public class AddBinaryIntegersAsList {
	...
	static List<Integer> addOld(List<Integer> a, List<Integer> b) {
		List<Integer> c = new ArrayList<>(a.size() >= b.size() ? a : b);
		List<Integer> d = new ArrayList<>(a.size() < b.size() ? a : b);
		int carry = 0;
	...
	public static void main(String[] args) {
		System.out.println(addOld(new ArrayList<>(Arrays.asList(1)), new ArrayList<>(Arrays.asList(0))));//1
		System.out.println(addOld(new ArrayList<>(Arrays.asList(1)), new ArrayList<>(Arrays.asList(1))));//1,0
		System.out.println(addOld(new ArrayList<>(Arrays.asList(1,1)), new ArrayList<>(Arrays.asList(1))));//1,0,0
		System.out.println(addOld(new ArrayList<>(Arrays.asList(1,0,1,1)), new ArrayList<>(Arrays.asList(1))));//1,1,0,0
		System.out.println(addOld(new ArrayList<>(Arrays.asList(1,0,0,0,0,1,1)), new ArrayList<>(Arrays.asList(1))));//1,0,0,0,1,0,0
