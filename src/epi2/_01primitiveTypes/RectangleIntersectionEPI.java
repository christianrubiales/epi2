 ...
 * R1.Y1 <= R2.Y2 &&
 * R1.Y2 >= R2.Y1
 * By default, if edge intersection is considered an intersection, equals sign is used.
 */
public class RectangleIntersectionEPI {
	  ...
	  public static boolean isIntersect(Rectangle R1, Rectangle R2) {
		  // De Morgan's simplification of !(!A or !B or !C or !D)
		  return R1.x <= R2.x + R2.width && R1.x + R1.width >= R2.x
		        && R1.y <= R2.y + R2.height && R1.y + R1.height >= R2.y;
	  }

	  public static boolean isIntersectSimple(Rectangle R1, Rectangle R2) {
		  return R1.x <= R2.x + R2.width && R1.x + R1.width >= R2.x
		        && R1.y <= R2.y + R2.height && R1.y + R1.height >= R2.y;
	  }
